...
{
    private const string ModuleName = "ml-runtime";
    ...
    private async Task RegisterAsync(CancellationToken ct)
    {
        ...
        var request = new
        {
            ...
            capabilities  = new[] { "onnx-inference", "model-registry", "hot-reload", "streaming-inference" },
            version       = "1.0.0",
        };
    ...
    private async Task DeregisterAsync(CancellationToken ct)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("MLRuntime deregistered from Block Controller.");
        }
        catch (Exception ex)
        {
