...
namespace MLS.DeFi.Hubs;

/// <summary>
/// SignalR hub for the DeFi module.
/// Connects on <c>/hubs/defi</c>.
...
/// </summary>
public sealed class DeFiHub : Hub
{
    /// <summary>Hub method — client sends an envelope to the DeFi hub.</summary>
