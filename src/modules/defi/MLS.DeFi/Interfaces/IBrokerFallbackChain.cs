...
/// <summary>
/// Executes DeFi order placement with automatic failover across configured broker venues.
...
public interface IBrokerFallbackChain
{
    ...
    /// </exception>
    Task<DeFiOrderResult> ExecuteWithFallbackAsync(DeFiOrderRequest request, CancellationToken ct);

    /// <summary>Returns the IDs of currently healthy (reachable) broker venues.</summary>
