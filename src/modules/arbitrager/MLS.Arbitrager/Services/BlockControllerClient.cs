...
/// <summary>
/// Hosted background service that registers the Arbitrager module with Block Controller
...
{
    private const string ModuleName = "arbitrager";
    ...
    private async Task RegisterAsync(CancellationToken ct)
    {
        ...
        var request = new
        {
            ...
            capabilities  = new[] { "arb-scan", "arb-score", "arb-execute", "nhop-path-finder" },
            version       = "1.0.0",
        };
        ...
        try
        {
            ...
            if (reg is not null)
            {
                ...
                _logger.LogInformation("Arbitrager registered with Block Controller as {Id}", _registeredId);
            }
        }
    ...
    private async Task DeregisterAsync(CancellationToken ct)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Arbitrager deregistered from Block Controller.");
        }
        catch (Exception ex)
        {
