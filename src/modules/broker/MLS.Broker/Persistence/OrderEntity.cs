...
/// <summary>
/// Represents a persisted order record in the <c>orders</c> PostgreSQL table.
/// </summary>
[Table("orders")]
public sealed class OrderEntity
{
    ...
    /// <summary>Exchange-assigned order ID; <see langword="null"/> until acknowledged.</summary>
    [MaxLength(128)]
    [Column("venue_order_id")]
    ...
    /// <summary>Order type string (Market, Limit, StopMarket, StopLimit).</summary>
    [Required]
    [MaxLength(16)]
    [Column("order_type")]
    ...
    /// <summary>Stop trigger price; <see langword="null"/> for non-stop orders.</summary>
    [Column("stop_price")]
    ...
    [MaxLength(24)]
    [Column("state")]
    public string State { get; set; } = OrderState.Pending.ToString();

    /// <summary>Cumulative filled quantity.</summary>
    [Column("filled_quantity")]
    public decimal FilledQuantity { get; set; }

    /// <summary>Volume-weighted average fill price; <see langword="null"/> when unfilled.</summary>
    ...
    /// <summary>Module ID of the requesting module (Trader or DeFi).</summary>
    [Required]
    [MaxLength(64)]
