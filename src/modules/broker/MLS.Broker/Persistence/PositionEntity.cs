...
/// <summary>
/// Represents the current open position for a symbol on a venue, persisted in the
/// <c>positions</c> PostgreSQL table.  Each (symbol, venue) pair has at most one row.
/// </summary>
[Table("positions")]
