...
/// <summary>
/// Hosted background service that registers the Broker module with Block Controller
...
{
    private const string ModuleName = "broker";
    ...
    private async Task RegisterAsync(CancellationToken ct)
    {
        ...
        var request = new
        {
            ...
            capabilities  = new[] { "order-placement", "fill-tracking", "position-management" },
            version       = "1.0.0",
        };
        ...
        try
        {
            ...
            if (reg is not null)
            {
                ...
                _logger.LogInformation("Broker registered with Block Controller as {Id}", _registeredId);
            }
        }
    ...
    private async Task DeregisterAsync(CancellationToken ct)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Broker deregistered from Block Controller");
        }
        catch (Exception ex)
        {
