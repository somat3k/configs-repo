...
/// Total end-to-end latency in milliseconds from when the <c>AI_QUERY</c> was received
/// to when this <c>AI_RESPONSE_COMPLETE</c> envelope is sent (includes context assembly,
/// provider selection, and all streaming).
/// </param>
...
/// Number of <c>AI_CANVAS_ACTION</c> envelopes dispatched by SK plugins during this response.
/// </param>
